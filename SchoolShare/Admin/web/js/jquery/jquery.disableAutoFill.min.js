(function(t){
    ...
    o.passwordListener = function(i, o){
        ...
        i.find("[type=password]").attr("type", "text").addClass("disabledAutoFillPassword"), 
        i.on("keyup", s, function(){
            for (var i = t(this).val(), s = i.length, n = this.selectionStart, a = 0; a < s; a++)
