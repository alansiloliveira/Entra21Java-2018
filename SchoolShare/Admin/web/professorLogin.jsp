    ...
    <body>
        <div class="global-login-wrapper">
            <div class="login-status">
                <form action="/validaLoginProfessor" method="POST" class="form-login" id="login-authenticate">
                    <div class="form-control-login">
                        ...
                        <div class="wrapper-login-center">
                            ...
                            <div class="center-components">
                                <label for="campoLoginProfessor">Usuário<%=asteriscs%></label>
                                <input type="text" class="form-control" id="campoLoginProfessor" name="fl-professor-login">

                            </div>

                            <div class="center-components">
                                <label for="campoSenhaProfessor">Senha<%=asteriscs%></label>
                                <input type="password" class="form-control" id="campoSenhaProfessor" name="fl-professor-password">
                            </div>
